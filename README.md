...
- [Huiyu-Pi](https://github.com/huiyu9144/pi-forge) - Local-first AI coding agent with pure Web UI. ~80 token system prompt, ~0.3s first token, 90%+ lower cost. Self-hosted, supports Claude/GPT/DeepSeek/Gemini. One command to start (npx pi-forge).
